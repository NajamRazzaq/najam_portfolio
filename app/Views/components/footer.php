<footer class="border-t border-slate-200/80 bg-slate-50/80 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-slate-200/70">
            ...
            <div class="lg:col-span-3 space-y-3">
                ...
                <div class="space-y-2 text-xs font-medium text-slate-700">
                    ...
                    <a href="tel:+923314712723" class="flex items-center gap-2 hover:text-black transition-colors">
                        <svg class="w-4 h-4 text-slate-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 font-medium">
            ...
            <a href="#home" class="inline-flex items-center gap-1.5 text-slate-600 hover:text-black transition-colors group">
                <span>Back to Top</span>
                <svg class="w-3.5 h-3.5 group-hover:-translate-y-0.5 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
